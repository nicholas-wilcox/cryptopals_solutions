...
RSpec.describe CryptUtil::Digest::MD4 do

  text = Random.bytes(rand(50..100))

  it 'produces the same hash as OpenSSL::Digest::MD4' do
    expect(subject.digest(text)).to eq(OpenSSL::Digest::MD4.digest(text))
  end
